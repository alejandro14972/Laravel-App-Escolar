<div>
    ...
    @if ($recursos->isNotEmpty())
        <div class="flex justify-between items-center p-4 ">
            <h2 class="text-lg font-semibold text-gray-800 dark:text-white">📚 Recursos públicos de
        ...
        <div class="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-1 gap-6">
            @foreach ($recursos as $recurso)
                ...
                <div class="border-gray-400 bg-slate-300 p-6 rounded-lg">
                    ...
                    <div class="mt-4 flex justify-between items-center">
                        <div class="flex space-x-4">
                            <!-- Ver más -->
                            <a href="{{ route('recursos.show', $recurso->id) }}" class="text-green-600">
                                🔍 Ver más
                            </a>
                        </div>
