<div>
    ...
    @if ($recursos->isNotEmpty())
        <div class="flex justify-between items-center p-4 ">
            <h2 class="text-lg font-semibold text-gray-800 dark:text-white">📚 Mis recursos favoritos</h2>
        </div>
        ...
        @else
            <div class="flex justify-center">
                <p class="text-gray-800 dark:text-white">Por ahora no tienes ningún recurso favorito 💖</p>
            </div>
    @endif
</div>
</div>
